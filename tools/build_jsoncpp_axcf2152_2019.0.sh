...
-D "CMAKE_STAGING_PREFIX=${DIR}/../build/axcf2152_2019.0/out" \
...
-B "${DIR}/../build/axcf2152_2019.0/external/jsoncpp" \

# Build the project
cmake --build "${DIR}/../build/axcf2152_2019.0/external/jsoncpp" --target install
